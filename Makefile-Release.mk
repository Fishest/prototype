...
${OBJECTDIR}/BaseStruct.o: BaseStruct.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/BaseStruct.o BaseStruct.cpp
...
${OBJECTDIR}/FileParser.o: FileParser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FileParser.o FileParser.cpp
...
${OBJECTDIR}/LifeStruct.o: LifeStruct.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/LifeStruct.o LifeStruct.cpp
